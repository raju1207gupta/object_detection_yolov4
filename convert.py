...
if __name__ == '__main__':
    ...
    # weights_path = "model_data/yolov4-4000_crowdperson-detection.weights"

    # model_path = 'yolov4-person_helmet_mask-detection.h5'
    # anchors_path = 'model_data/anchors_PPE.txt'
    # classes_path = 'model_data/person_helmet_mask_classes.txt'
    # weights_path = "model_data/yolov4_person_helmet_mask_4300-obj_last.weights"

    model_path = 'yolov4_80_classes.h5'
    anchors_path = 'model_data/anchors_PPE.txt'
    classes_path = 'model_data/coco_classes.txt'
    weights_path = "model_data/yolov4_80classes.weights"
    ...
    yolo4_model = Yolo4(score, iou, anchors_path, classes_path, model_path, weights_path,-1)
